        ...
        <div className="flex min-h-full items-center justify-center p-4 text-center">
          <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
            ...
            <div className="m-20 p-6 bg-white backdrop-grayscale rounded-2xl shadow-2xl">
              ...
              <h3>
                {book?.status === "Unread" ? (
                  <div className="bg-slate-100 font-semibold text-slate-400 text-xs w-fit rounded-xl px-3 py-0.5 lowercase my-2">
                    To read
                  </div>
                ) : (
                  book?.status
              ...
              <div className="flex w-full justify-between mt-5">
                ...
                >
                  {book?.isFavourite ? (
                    <HeartFilled className="fill-red-400 drop-shadow-sm transition-all  hover:fill-red-500 mt-0.5" />
                  ) : (
                    <HeartEmpty className="fill-slate-300 drop-shadow-sm transition-all  hover:fill-slate-400 mt-0.5" />
                  )}
                </button>
                <div>
                  <button
                  ...
                  >
                    <Edit className="fill-gray-300 drop-shadow-sm transition-all hover:fill-gray-400" />
                  </button>
                  <button
                    type="button"
                    onClick={handleDelete}
                    className="focus:outline-none"
                  >
                    <Delete className="fill-gray-300 drop-shadow-sm transition-all hover:fill-gray-400" />
                  </button>
                </div>
              </div>
            </div>
